...
var useDelayRender = () => {
  ...
  const delayRender2 = (0, import_react16.useCallback)((label2, options) => {
    if (!scope) {
      return Math.random();
    }
    return delayRenderInternal({
...
var TimelineContextProvider = ({ children, frameState }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(TimelineContext.Provider, {
    value: timelineContextValue,
    children: (0, import_jsx_runtime6.jsx)(SetTimelineContext.Provider, {
...
var Folder = ({ name, children }) => {
  const parent = (0, import_react51.useContext)(FolderContext);
  const { registerFolder, unregisterFolder } = (0, import_react51.useContext)(CompositionSetters);
...
var InnerComposition = ({
  ...
  if (environment.isStudio && video && video.component === lazy && video.id === id) {
    ...
    return (0, import_react_dom.createPortal)((0, import_jsx_runtime23.jsx)(CanUseRemotionHooksProvider, {
      children: (0, import_jsx_runtime23.jsx)(import_react50.Suspense, {
...
var RemotionRootContexts = ({
  ...
  return (0, import_jsx_runtime28.jsx)(LogLevelContext.Provider, {
    ...
    children: (0, import_jsx_runtime28.jsx)(NonceContext.Provider, {
      value: nonceContext,
      children: (0, import_jsx_runtime28.jsx)(TimelineContextProvider, {
        frameState,
        children: (0, import_jsx_runtime28.jsx)(MediaEnabledProvider, {
          ...
          children: (0, import_jsx_runtime28.jsx)(EditorPropsProvider, {
            children: (0, import_jsx_runtime28.jsx)(PrefetchProvider, {
              children: (0, import_jsx_runtime28.jsx)(SequenceManagerProvider, {
                children: (0, import_jsx_runtime28.jsx)(SharedAudioContextProvider, {
                  numberOfAudioTags,
                  audioLatencyHint,
                  audioEnabled,
...
var useCurrentScale = (options) => {
  const hasContext = import_react61.default.useContext(CurrentScaleContext);
  const zoomContext = import_react61.default.useContext(PreviewSizeContext);
...
var OffthreadVideoForRendering = ({
  ...
  const className = (0, import_react63.useMemo)(() => {
...
var Still = (props2) => {
  ...
  return import_react70.default.createElement(Composition, newProps);
};
...
//# sourceMappingURL=chunk-DNND6QTT.js.map
