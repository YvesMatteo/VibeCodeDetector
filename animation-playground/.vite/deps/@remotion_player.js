...
var usePlayer = () => {
  ...
  const { audioAndVideoTags } = (0, import_react8.useContext)(Internals.TimelineContext);
  ...
  const isPlaying = (0, import_react8.useCallback)(() => {
    return imperativePlaying.current;
  }, [imperativePlaying]);
  const getCurrentFrame = (0, import_react8.useCallback)(() => {
    return frameRef.current;
  }, [frameRef]);
  const isBuffering = (0, import_react8.useCallback)(() => {
...
var PlaybackPopup = ({ setIsComponentVisible, playbackRates, canvasSize }) => {
  const { setPlaybackRate, playbackRate } = (0, import_react16.useContext)(Internals.TimelineContext);
...
var PlaybackrateControl = ({ playbackRates, canvasSize }) => {
  ...
  const { playbackRate } = (0, import_react16.useContext)(Internals.TimelineContext);
  const onClick = (0, import_react16.useCallback)((e) => {
    e.stopPropagation();
    e.preventDefault();
    ...
    children: [
      (0, import_jsx_runtime10.jsxs)("div", {
        ...
        children: [
          ...
          customControlsElement && playbackRates && canvasSize ? (0, import_jsx_runtime10.jsx)("div", {
            style: xSpacer
          }) : null,
  ...
  return (0, import_jsx_runtime14.jsx)(Internals.RemotionEnvironmentContext.Provider, {
    ...
    children: (0, import_jsx_runtime14.jsx)(Internals.LogLevelContext.Provider, {
      ...
      children: (0, import_jsx_runtime14.jsx)(Internals.CanUseRemotionHooksProvider, {
        children: (0, import_jsx_runtime14.jsx)(Internals.TimelineContext.Provider, {
...
var validateDefaultAndInputProps2 = NoReactInternals.validateDefaultAndInputProps;
...
var PlayerFn = ({
  ...
  validateDimension2(compositionHeight, "compositionHeight", "of the <Player /> component");
  validateDimension2(compositionWidth, "compositionWidth", "of the <Player /> component");
  validateDurationInFrames2(durationInFrames, {
    component: "of the <Player/> component",
    allowFloats: false
  });
  validateFps2(fps, "as a prop of the <Player/> component", false);
  validateDefaultAndInputProps2(inputProps, "inputProps", null);
  validateInOutFrames({
    durationInFrames,
    inFrame,
    outFrame
  ...
  return (0, import_jsx_runtime15.jsx)(Internals.IsPlayerContextProvider, {
    children: (0, import_jsx_runtime15.jsx)(SharedPlayerContexts, {
      ...
      audioEnabled: true,
      children: (0, import_jsx_runtime15.jsx)(Internals.SetTimelineContext.Provider, {
