...
export default function SecurityShieldAnimation() {
    return (
        <div className="relative w-full h-64 bg-zinc-900 rounded-xl overflow-hidden border border-white/5 flex items-center justify-center group">
            {/* Shield Svg */}
            ...
            {[...Array(3)].map((_, i) => (
                ...
                >
                    <div className="absolute top-0 left-1/2 w-1 h-1 bg-emerald-500/50 rounded-full" />
                </motion.div>
            ))}
        </div>
    );
